...
#
#  Runs Bracken on Kraken2 reports from extracted 16S reads, then combines
#  all library-level outputs into a single genus table.
#
#  Prerequisites:
#    - Kraken2 step completed (submit_kraken2_p3_zymo.sh)
...
echo "=== Pipeline 3 — MGS: Bracken genus-level estimation (extracted 16S reads) ==="
echo ""
